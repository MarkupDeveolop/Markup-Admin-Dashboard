...
const BrandForm: React.FC<CategoryFormProps> = ({ initialData }) => {
    ...
    try {
      ...
      if (initialData) {
        const response = await axios.patch(
          `${DOMAIN}/api/home/brand/${params.slug}`,
          data
        );
        console.log("Update Response:", response.data);
      } else {
        const response = await axios.post(`${DOMAIN}/api/home/brand`, data);
        console.log("Create Response:", response.data);
      }

      toast.success(toastMessage);
      router.push(`/home/brand`);
      router.refresh();
    } catch (error: any) {
  ...
  const onDelete = async () => {
    try {
      setLoading(true);
      await axios.delete(`${DOMAIN}/api/home/brand/${params.slug}`);
      router.refresh();
      router.push(`/home`);
