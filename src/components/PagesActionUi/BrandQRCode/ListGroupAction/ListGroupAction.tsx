...
import { Grip, Pencil, Trash, Search, X, QrCode } from "lucide-react";
...
const ListGroupAction = ({
  ...
  const [brandQrCode, setBrandQrCode] = useState<BrandQRCodeType[]>([]);
